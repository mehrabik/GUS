...
public class ActivityStackSupervisor implements RecentTasks.Callbacks {
    ...
    /** CAGADroid: Service Instance **/
    private CAGADroidSecurityManager mCAGADroidService;
    /** CAGADroid: Service Instance (End) **/
    ...
    // CAGADroid: function to check the startActivity with SM
    private int checkCAGADroidAccess(String packageName, String className) {
        if (mCAGADroidService == null) {
            Log.w("CAGADroid", "ActivityStackSupervisor: Reinstantiating CAGADroidSecurityManager Service");
            mCAGADroidService = CAGADroidSecurityManager.getInstance();
        }
        return mCAGADroidService.checkPolicy(packageName, className, CAGADroidConstants.OPERATION_START_ACTIVITY);
    }
    // CAGADroid: end
    ...
    int startActivityFromRecents(int callingPid, int callingUid, int taskId,
        ...
        try {
            ...
            // CAGADroid: Perform ActivityLocker check
            String subject = "Unknown";
            String object = "Unknown";
            if(task.getTaskInfo().topActivity != null) {
                subject = task.getTaskInfo().topActivity.getPackageName();
                object = task.getTaskInfo().topActivity.getClassName();
            }
            Log.d("CAGA.PE", "ActivityStackSupervisor.startActivityFromRecents:"
                                                            + "Subject=" + subject
                                                            + ", Object=" + object);
